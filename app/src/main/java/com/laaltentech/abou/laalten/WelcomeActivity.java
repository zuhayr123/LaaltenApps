...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private Button btnSkip, btnNext;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            dotsView = findViewById(R.id.linelayout);
        ...
        private void launchHomeScreen() {
            startActivity(new Intent(WelcomeActivity.this, MiddleScreen.class));
            finish();
        }
        ...
        ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if(position==1||position==3){
                    ...
                    dotsView.setBackgroundColor(Color.WHITE);
                }

                else{
                    btnNext.setTextColor(Color.DKGRAY);
                    btnSkip.setTextColor(Color.DKGRAY);
                    dotsView.setBackgroundColor(Color.DKGRAY);
                }
